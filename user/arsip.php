                    ...
                    <div class="row">
                        <div class="col-lg-6 col-md-6 col-sm-6 col-xs-12">
                            <div class="breadcome-heading">
                                <h4 style="margin-bottom: 0px">Data File Semua User</h4>
                            </div>
                        </div>
                        <div class="col-lg-6 col-md-6 col-sm-6 col-xs-12">
            ...
            <table id="table" class="table table-bordered table-striped table-hover table-datatable">
                ...
                <tbody>
                    ...
                    if(isset($_GET['kategori'])){
                        ...
                        $arsip = mysqli_query($koneksi,"SELECT * FROM arsip,kategori,user WHERE arsip_petugas=user_id and arsip_kategori=kategori_id and arsip_kategori='$kategori' ORDER BY arsip_id DESC");
                    }else{
                        $arsip = mysqli_query($koneksi,"SELECT * FROM arsip,kategori,user WHERE arsip_petugas=user_id and arsip_kategori=kategori_id ORDER BY arsip_id DESC");
                    }
