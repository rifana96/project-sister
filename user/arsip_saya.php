                    ...
                    <div class="row">
                        <div class="col-lg-6 col-md-6 col-sm-6 col-xs-12">
                            <div class="breadcome-heading">
                                <h4 style="margin-bottom: 0px">Unggah File</h4>
                            </div>
                        </div>
                        <div class="col-lg-6 col-md-6 col-sm-6 col-xs-12">
...
<div class="container-fluid">
    <div class="panel panel">
        ...
        <div class="panel-heading">
            <h3 class="panel-title">Data File Saya</h3>
        </div>
        <div class="panel-body">


            <div class="pull-right">
                <a href="arsip_tambah.php" class="btn btn-primary"><i class="fa fa-cloud"></i> Upload File</a>
            </div>
            ...
            <center>
                ...
                if(isset($_GET['alert'])){
                    if($_GET['alert'] == "gagal"){
                        ?>
                        <div class="alert alert-danger">File gagal diupload. karena demi keamanan file .php tidak diperbolehkan.</div>
                        <?php
                    }else{
                        ?>
                        <div class="alert alert-success">File berhasil tersimpan.</div>
                        <?php
                    }
                }
                ?>
            ...
            <table id="table" class="table table-bordered table-striped table-hover table-datatable">
                ...
                <tbody>
                    ...
                    $no = 1;
                    $saya = $_SESSION['id'];
                    $file = mysqli_query($koneksi,"SELECT * FROM arsip,kategori,user WHERE arsip_petugas=user_id and arsip_kategori=kategori_id and arsip_petugas='$saya' ORDER BY arsip_id DESC");
                    while($p = mysqli_fetch_array($file)){
                        ?>
                        <tr>
                            <td><?php echo $no++; ?></td>
