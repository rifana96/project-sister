...
<head>
    ...
    <!-- <title>User - Sistem Penyimpanan Berkas Terdistribusi</title> -->
    ...
    <div class="left-sidebar-pro">
        <nav id="sidebar" class="">
            <div class="sidebar-header">
                <img class="main-logo" src="../assets/img/logo/kelompok9.png" alt="" />
            ...
            <div class="left-custom-menu-adp-wrap comment-scrollbar">
                ...
                <nav class="sidebar-nav left-sidebar-menu-pro" style="margin-top: 20px">
                    ...
                    <ul class="metismenu" id="menu1">
                        <li>
                            <a href="profil.php" aria-expanded="false"><span class="educate-icon educate-professor icon-wrap sub-icon-mg" aria-hidden="true"></span> <span class="mini-click-non">Profil</span></a>
                        </li> 
                        ...
                        <li>
                            <a href="arsip_saya.php" aria-expanded="false"><span class="educate-icon educate-data-table icon-wrap sub-icon-mg" aria-hidden="true"></span> <span class="mini-click-non">Unggah</span></a>
                        </li>
                        
                        <li>
                            <a href="arsip.php" aria-expanded="false"><span class="educate-icon educate-course icon-wrap sub-icon-mg" aria-hidden="true"></span> <span class="mini-click-non">Data Arsip</span></a>
                        </li>
                                        ...
                                        <ul class="nav navbar-nav mai-top-nav header-right-menu">
                                            ...
                                            <li class="nav-item">
                                                <a class="nav-link dropdown-toggle">
                                                    ...
                                                    ?> -->
                                                    <!-- <span class="admin-name">Halo, <?php echo $_SESSION['nama']; ?> < <b>User</b> ></span> -->
                                                    <span class="admin-name">Hai 👋, <?php echo $_SESSION['nama']; ?></span>
